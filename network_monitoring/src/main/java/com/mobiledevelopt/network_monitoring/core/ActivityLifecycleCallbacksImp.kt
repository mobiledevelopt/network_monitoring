package com.mandy.network_monitoring.core
...
import com.mandy.network_monitoring.NetworkConnectivityListener
 ...
 */
internal class ActivityLifecycleCallbacksImp(private val networkState: NetworkStateImp) : Application.ActivityLifecycleCallbacks{
